...
class OrganizationAggregateTest extends TestCase
{
    ...
    public function testCreateBootstrapsOwnersTeamWithCreator(): void
    {
        ...
        $organization = Organization::create($id, new Slug('acme'), new DisplayName('ACME Corp'), $ownersTeamId, self::CREATOR);
    ...
    public function testReconstituteRebuildsStateFromHistory(): void
    {
        $id = new Ulid();
        $ownersTeamId = new Ulid();
        $created = Organization::create($id, new Slug('acme'), new DisplayName('ACME Corp'), $ownersTeamId, self::CREATOR);
