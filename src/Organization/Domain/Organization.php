...
final class Organization extends AbstractAggregate
{
    ...
    public static function create(Ulid $id, Slug $slug, DisplayName $displayName, Ulid $ownersTeamId, Ulid $allMembersTeamId, int $creatorUserId): self
    {
        $organization = new self($id);
        $organization->record(new OrganizationCreated($id, $slug->value, $displayName->value, $ownersTeamId, $allMembersTeamId, $creatorUserId));
    ...
    private function applyCreated(OrganizationCreated $event): void
    {
        ...
        $this->teamMembers[$event->ownersTeamId->toRfc4122()] = [$event->creatorUserId];
        ...
        $this->teamMembers[$event->allMembersTeamId->toRfc4122()] = [$event->creatorUserId];
    }
